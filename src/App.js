      ...
      <div className="flex flex-col items-center w-full">
        ...
        <div className="w-1/2 p-4 mt-4 bg-white border rounded-sm">
          <TabList {...tab} aria-label="semp url forms" className="border-b">
            <Tab {...tab} stopId="cloud" className="p-2">
              <div className="flex flex-col">
                <div>Cloud</div>
                <div
                  style={{ content: "" }}
                  className={`flex h-1 mt-2 ${
                    tab.currentId === "cloud" ? "bg-green-500" : ""
                  }`}
                />
              </div>
            </Tab>
            <Tab {...tab} stopId="ip-port" className="p-2">
              <div className="flex flex-col">
                <div>Ip and port</div>
                <div
                  style={{ content: "" }}
                  className={`flex h-1 mt-2 ${
                    tab.currentId === "ip-port" ? "bg-green-500" : ""
                  }`}
                />
              </div>
            </Tab>
          </TabList>
          <TabPanel {...tab} stopId="cloud">
            <Formik
              initialValues={{
                sempUsername: ``,
                sempPassword: ``,
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <Field name="sempBasePath">
                    {({
                      ...
                      <div className="flex flex-col mt-4">
                        <label htmlFor="sempBasePath">SEMP base path</label>
                        <input
                          {...field}
                          className="border rounded-sm"
                          id="sempBasePath"
                          placeholder="E.g. https://example.messaging.solace.cloud:943/SEMP/v2/config"
                        />
                      </div>
                    )}
                  </Field>
